...
const TransactionCard = ({ transaction }: Props) => {
  ...
  return (
    <motion.div 
        className={`bg-slate-900 hover:bg-slate-800 w-full py-2 my-2 px-4 rounded-3xl grid grid-cols-6`}>
        <div 
            onClick={() => setOpen(true)}
            className="overflow-scroll grid grid-cols-4 lg:grid-cols-5 gap-20 cursor-pointer col-span-5">
            ...
            <p className="text-xs lg:col-span-2 text-slate-200 my-auto">{
